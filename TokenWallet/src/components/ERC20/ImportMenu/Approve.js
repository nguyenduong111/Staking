...
const Approve = ({ web3Token }) => {
    ...
    const onClickApprove = async () => {
        ...
        try {
            ...
            await web3Token.methods.approve(data.arg1, data.arg2).send({ from: accounts[0] });
            successMessage = `Approval successful. ${data.arg2} approved to ${data.arg1}`;
